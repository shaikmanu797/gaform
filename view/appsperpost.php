...
*/
session_start();
if($_SESSION['loggedin']=='yes'&&($_SESSION['role']=='1' || $_SESSION['role']=='5')){
    ...
    if($_SESSION['role']=="1"){
        echo   '<li><a href="home.php">Home</a></li>
                            ...
                            <li class="active"><a href="applicants.php">Received Applications</a></li>
...
<div class="container">
    ...
    require("appsperpost-content.php");
    echo '</div>
    </div>
</div>
</body>';
